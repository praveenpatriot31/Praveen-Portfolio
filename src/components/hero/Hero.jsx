...
const STATS_CARDS_MAP = [
  {
    ...
    transformClass:
      "md:-translate-x-[270px] md:-translate-y-[190px] lg:-translate-x-[285px] lg:-translate-y-[205px]",
    phaseShift: 0,
    isStatus: false,
  },
  {
    ...
    transformClass:
      "md:translate-x-[65px] md:-translate-y-[190px] lg:translate-x-[80px] lg:-translate-y-[205px]",
    phaseShift: 1,
    isStatus: false,
  },
  {
    ...
    transformClass:
      "md:-translate-x-[255px] md:translate-y-[100px] lg:-translate-x-[270px] lg:translate-y-[115px]",
    phaseShift: 2,
    isStatus: true,
  },
  {
    ...
    transformClass:
      "md:translate-x-[75px] md:translate-y-[100px] lg:translate-x-[90px] lg:translate-y-[115px]",
    phaseShift: 3,
    isStatus: false,
  },
];
      ...
      <motion.div
        ...
        className={`
          ...
          ${
            isStatus
              ? `
                bg-[rgba(255,69,58,0.035)]
                border-[rgba(255,69,58,0.16)]
                shadow-[0_24px_48px_-12px_rgba(255,69,58,0.08)]
              `
              : `
        ...
        <div className="flex items-center gap-3">
          ...
          <h3
            className={`
              ...
              tracking-tight
              leading-none
              ${value === "Open" ? "text-[27px]" : "text-[28px]"}
            `}
          >
            {value}
          </h3>
      ...
      >
        ...
        <div
          className="
            ...
            pointer-events-none
            z-0
            bg-[radial-gradient(circle_at_75%_45%,rgba(255,69,58,0.1),transparent_60%)]
            mix-blend-screen
          "
        />
        ...
        <div
          className="
            ...
            pointer-events-none
            z-0
            bg-[radial-gradient(circle_at_25%_20%,rgba(255,255,255,0.02),transparent_48%)]
          "
        />
          ...
          >
            ...
            >
              ...
              {/* =================================================
                  ...
                  IMPORTANT:
                  Increased spacing between lines and reduced
                  maximum desktop size to prevent clipping.
              ================================================= */}
              ...
              <motion.p
                ...
                "
              >
                Creative Visual Designer with 5+ years of
                experience in visual design, brand campaigns,
                motion graphics, video, VFX compositing and
              ...
              >
                <motion.a
                  ...
                  className="
                    ...
                    text-[14px]
                    tracking-[0.2em]
                    shadow-[0_12px_32px_rgba(255,255,255,0.06)]
                    transition-all
                    duration-300
                    min-h-[48px]
                    cursor-pointer
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  transition={ringSpinTransition(180)}
                  className="
                    absolute
                    w-[520px]
                    h-[520px]
                ...
                <motion.div
                  ...
                  transition={ringSpinTransition(140)}
                  className="
                    absolute
                    w-[420px]
                    h-[420px]
                ...
                <motion.div
                  ...
                  transition={ringSpinTransition(100)}
                  className="
                    absolute
                    w-[330px]
                    h-[330px]
                ...
                <motion.div
                  ...
                  className="
                    ...
                    bg-black
                    backdrop-blur-3xl
                    shadow-[0_0_80px_rgba(255,69,58,0.16)]
                    flex
                    flex-col
                    items-center
                    justify-center
                ...
                >
                  <img
                    ...
                    alt="Praveen S. Creative Visual Designer"
                    className="
                      absolute
                      inset-0
                      h-full
                ...
                {STATS_CARDS_MAP.map((stat) => (
                  <FloatingStatCard
                    ...
                    value={stat.value}
                    label={stat.label}
                    transformClass={stat.transformClass}
                    phaseShift={stat.phaseShift}
                    isStatus={stat.isStatus}

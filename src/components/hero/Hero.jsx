    ...
    <>
      ...
      >
              ...
              <div className="relative md:absolute w-full max-w-[460px] md:max-w-none md:w-[460px] h-auto md:h-[460px] flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0">
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/80 to-transparent pt-16 pb-8 flex flex-col items-center pointer-events-none z-10">
                    ...
                    <p className="tracking-[0.25em] text-[#FF453A] mt-1.5 uppercase text-[11px] font-semibold">
                      Creative Designer
                    </p>
                  </div>
                </motion.div>
                ...
                <FloatingStatCard
                  value={AVAILABILITY_CARD_MAP.value}
                  label={AVAILABILITY_CARD_MAP.label}
                  transformClass={AVAILABILITY_CARD_MAP.transformClass}
                  phaseShift={3}
                  isStatus={true}
                  shouldReduceMotion={shouldReduceMotion}
                />
        ...
        <motion.div
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 pointer-events-none z-20"
        >
          <div className="w-[24px] h-[40px] rounded-full border-2 border-white/20 flex justify-center p-1.5 bg-black/20 backdrop-blur-sm">
            <motion.div
              ...
              className="w-[3px] h-[8px] rounded-full bg-[#FF453A]"
            />
          </div>
          <span className="text-[10px] tracking-[0.3em] font-bold text-white/30 uppercase mt-1 pl-[0.3em]">
            Scroll
          </span>
        </motion.div>
      </section>
